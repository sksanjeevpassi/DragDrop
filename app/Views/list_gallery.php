...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css">
    ...
    <style>
        ...
        .gallery img{ width:250px;height:130px;}
    </style>
...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item"><a href="/add-gallery">Add Gallery</a>
            </li>
            <li class="menu-item"><a href="/list-gallery">Gallery</a></li>
        </ul>
    </div>
</header>
		...
		<div class="container">
			<div>		
				<div class="gallery">
					...
					?>
						<li id="<?php  echo $val->id; ?>" class="ui-sortable-handle"><a href="javascript:void(0);"><img src="images/<?php echo $val->image_name; ?>" alt=""></a></li>
					<?php  }} ?>
					</ul>
				</div>
			</div>
            <?php if(count($galleries) <= 0){ ?>
                <p> Please Add Image from <a href="/add-gallery">Add Gallery</a> Page </p>
            <?php } ?>
		</div>
