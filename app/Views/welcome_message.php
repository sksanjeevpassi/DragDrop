...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="/add-gallery">Add Gallery</a>
            </li>
            <li class="menu-item hidden"><a href="/list-gallery">Gallery</a></li>
        </ul>
    </div>
</header>
...
<section>
    ...
    <p>Drag and Drop Image Thumbnails.</p>

    <p>If you would like to Upload images on gallery.</p>

    <pre><code>Go to "Image Upload" Menu</code></pre>

    <p>If you would like to Drag and Drop feature for reorder thumbnails.</p>

    <pre><code>Go to "Gallery Menu"</code></pre>
...
<footer>
    ...
    <div class="copyrights">
        ...
        <p>&copy; <?= date('Y') ?> Created By sksanjeevpassi@gmail.com</p>
